...
const lessonPlans = [
  {
    ...
    lessonPlan: {
      deliverables: [
        {
          id: "1",
          text: "Students completed sections 1 and 2 of the worksheet.",
          checked: false,
        },
        {
          id: "2",
          text: "Take attendance and check for any absences.",
          checked: false,
        },
        {
          id: "3",
          text: "Students read chapters 10 and 11 of the The Great Gatsby.",
          checked: false,
        },
        {
          id: "4",
          text: "Walk students to the library to pick up their books.",
          checked: false,
        },
        {
          id: "5",
          text: "Walk students to the music room for music class with Mr. Smith.",
          checked: false,
        },
      ],
      ...
      period_3: "A journey through music history, exploring different eras and their cultural significance",
      period_4: "Students will analyze and interpret artworks, developing their critical thinking skills.",
      period_5: "A continuation of the previous period, delving deeper into artistic techniques and styles.",
      period_6: "Students will participate in a range of activities to assess their physical fitness levels",
      afternoon_recess: "Students will have a 15-minute break to stretch and relax.",
      period_7: "Experimentation and observation in science, with a focus on scientific reporting.",
      period_8: "Editing and refining drama scripts, exploring creative writing techniques.",
      lunch: "Students will have a 30-minute lunch break.",
      other_notes: "Make sure to have a fun time and make sure to have a good time.",
    },
  },
  {
    id: "2",
